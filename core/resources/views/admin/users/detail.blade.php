        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-money-bill-wave-alt" title="Balance" value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" bg="19" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" icon="las la-wallet" title="Deposits" value="{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}" bg="primary" />

                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.withdraw.log') }}?search={{ $user->username }}" icon="fas fa-wallet" title="Withdrawals" value="{{ $general->cur_sym }}{{ showAmount($totalWithdrawals) }}" bg="1" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" icon="las la-exchange-alt" title="Transactions" value="{{ $totalTransaction }}" bg="17" />
                </div>
            </div>
            <div class="row gy-4 mt-2">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.report.invest') }}?search={{ $user->username }}&exact_match=true" icon="las la-money-bill-wave-alt" title="Total Invest" value="{{ $general->cur_sym }}{{ showAmount($user->total_invest) }}" bg="15" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.report.referral.commission') }}?search={{ $user->username }}&exact_match=true" icon="las la-wallet" title="Total Referral Commission" value="{{ $general->cur_sym }}{{ showAmount($user->total_ref_com) }}" bg="1" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.report.binary.commission') }}?search={{ $user->username }}&exact_match=true" icon="fas fa-wallet" title="Total Binary Commission" value="{{ $general->cur_sym }}{{ showAmount($user->total_binary_com) }}" bg="primary" />
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="3" link="{{ route('admin.ticket.index') }}" icon="las la-ticket-alt" title="Total Ticket" value="{{ $data['totalTicket'] }}" bg="3" />
                </div>
                <div class="col-xxl-3 col-sm-6">
