...
class WithdrawController extends Controller
{
    ...
    public function withdrawLog(Request $request)
    {
        ...
        $withdraws = Withdrawal::searchable(['trx', 'status'], false)->where('user_id', auth()->id())->where('status', '!=', Status::PAYMENT_INITIATE)->with('method')->orderBy('id', 'desc')->paginate(getPaginate());
