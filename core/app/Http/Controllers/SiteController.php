...
class SiteController extends Controller
{
    ...
    public function blogDetails($id, $slug)
    {
        ...
        $latestBlogs = Frontend::whereNot('id', $id)->where('data_keys', 'blog.element')->get();
        ...
        $seoContents['image']              = getImage('assets/images/frontend/blog/' . @$blog->data_values->blog_image, '1170x550');
        $seoContents['image_size']         = '1170x550';

        return view($this->activeTemplate . 'blog_details', compact('blog', 'latestBlogs', 'pageTitle', 'seoContents'));
    }
